...
CBC=['cbc/cbc03/HLV_time_cbc_with_'+ntype+'_noise_SNR20_XM',
     'cbc/cbc03/HLV_time_cbc_with_'+ntype+'_noise_SNR18_XM',
     'cbc/cbc03/HLV_time_cbc_with_'+ntype+'_noise_SNR16_XM',
     'cbc/cbc03/HLV_time_cbc_with_'+ntype+'_noise_SNR14_XM',
     'cbc/cbc03/HLV_time_cbc_with_'+ntype+'_noise_SNR12_XM',
     'cbc/cbc03/HLV_time_cbc_with_'+ntype+'_noise_SNR10_XM',
     'cbc/cbc03/HLV_time_cbc_with_'+ntype+'_noise_SNR8_XM',
     'cbc/cbc03/HLV_time_cbc_with_'+ntype+'_noise_SNR6_XM']
NOISE=['noise/'+ntype+'/real03/HLV_time_'+ntype+'_noise_No1_XM',    
       'noise/'+ntype+'/real03/HLV_time_'+ntype+'_noise_No2_XM',
       'noise/'+ntype+'/real03/HLV_time_'+ntype+'_noise_No3_XM',
       'noise/'+ntype+'/real03/HLV_time_'+ntype+'_noise_No4_XM',
       'noise/'+ntype+'/real03/HLV_time_'+ntype+'_noise_No5_XM',
       'noise/'+ntype+'/real03/HLV_time_'+ntype+'_noise_No6_XM',
       'noise/'+ntype+'/real03/HLV_time_'+ntype+'_noise_No7_XM',
       'noise/'+ntype+'/real03/HLV_time_'+ntype+'_noise_No8_XM']
...
historia.append(train_model(model = model 
                            ,data_fusion([CBC[0],NOISE[0]],[10000,10000])              
                            , 80, 500, 0.1 ,save_model=False)         
...
historia.append(train_model(model
                            ...
                            , 80, 500, 0.1, save_model=ntype+'hlv_30TO10_2_toSNR14'))
historia.append(train_model(model
                            ,data_fusion([CBC[4],NOISE[4]],[10000,10000])
                            , 80, 500, 0.1, save_model=ntype+'hlv_30TO10_2_toSNR12'))
historia.append(train_model(model
                            ,data_fusion([CBC[5],NOISE[5]],[10000,10000])
                            , 80, 500, 0.1, save_model=ntype+'hlv_30TO10_2_toSNR10'))
historia.append(train_model(model
                            ,data_fusion([CBC[6],NOISE[6]],[10000,10000])
                            , 80, 500, 0.1, save_model=ntype+'hlv_30TO10_2_toSNR8'))
historia.append(train_model(model
                            ,data_fusion([CBC[7],NOISE[7]],[10000,10000])
                            , 80, 500, 0.1, save_model=ntype+'hlv_30TO10_2_toSNR6')) 
