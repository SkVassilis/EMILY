...
CBC=['cbc/cbc02/HLV_time_cbc_with_'+ntype+'_noise_SNR20_XM',
     'cbc/cbc02/HLV_time_cbc_with_'+ntype+'_noise_SNR18_XM',
     'cbc/cbc02/HLV_time_cbc_with_'+ntype+'_noise_SNR16_XM',
     'cbc/cbc02/HLV_time_cbc_with_'+ntype+'_noise_SNR14_XM',
     'cbc/cbc02/HLV_time_cbc_with_'+ntype+'_noise_SNR12_XM',
     'cbc/cbc02/HLV_time_cbc_with_'+ntype+'_noise_SNR10_XM',
     'cbc/cbc02/HLV_time_cbc_with_'+ntype+'_noise_SNR8_XM',
     'cbc/cbc02/HLV_time_cbc_with_'+ntype+'_noise_SNR6_XM']
NOISE=['noise/'+ntype+'/real02/HLV_time_'+ntype+'_noise_No1_XM',    
       'noise/'+ntype+'/real02/HLV_time_'+ntype+'_noise_No2_XM',
       'noise/'+ntype+'/real02/HLV_time_'+ntype+'_noise_No3_XM',
       'noise/'+ntype+'/real02/HLV_time_'+ntype+'_noise_No4_XM',
       'noise/'+ntype+'/real02/HLV_time_'+ntype+'_noise_No5_XM',
       'noise/'+ntype+'/real02/HLV_time_'+ntype+'_noise_No6_XM',
       'noise/'+ntype+'/real02/HLV_time_'+ntype+'_noise_No7_XM',
       'noise/'+ntype+'/real02/HLV_time_'+ntype+'_noise_No8_XM']
