...
historia.append(train_model(model,data_fusion([CBC[1],NOISE[1]]), 30, 500, 0.1, save_model=False))
historia.append(train_model(model,data_fusion([CBC[2],NOISE[2]]), 30, 500, 0.1, save_model=False)) 
historia.append(train_model(model,data_fusion([CBC[3],NOISE[3]]), 30, 500, 0.1, save_model=False))
historia.append(train_model(model,data_fusion([CBC[4],NOISE[4]]), 30, 500, 0.1, save_model=False))
historia.append(train_model(model,data_fusion([CBC[5],NOISE[5]]), 30, 500, 0.1, save_model=False))
historia.append(train_model(model,data_fusion([CBC[6],NOISE[6]]), 30, 500, 0.1, save_model=ntype+'hlv_30TO10')) 
